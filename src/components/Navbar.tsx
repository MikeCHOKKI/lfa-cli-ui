...
export default function Navbar() {
  ...
  const handleCopyInstall = () => {
    navigator.clipboard.writeText('curl -fsSL https://lfa-cli.vercel.app/install.sh | sh').catch(() => {})
    setCopied(true)
        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <button
              ...
              className="group flex items-center gap-2 px-3 py-1.5 rounded-lg bg-lfa-bg border border-lfa-accent/30 text-[11px] font-mono text-lfa-text hover:bg-lfa-accent/10 hover:border-lfa-accent/50 transition-all cursor-pointer"
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub — MikeCHOKKI/lfa-cli-ai"
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-lfa-text/60 hover:text-lfa-accent p-2 rounded-md focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-lfa-accent"
            >
